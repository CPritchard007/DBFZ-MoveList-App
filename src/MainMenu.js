...
import { Animated, View, Button, SafeAreaView, StyleSheet, StatusBar, Text, Dimensions, TouchableOpacity } from 'react-native'
...
export const MainMenu = function ({navigation}) {
    ...
    const CustomBlockButton = ({title, pushTo, disabled}) => (
        <TouchableOpacity onPress={() => navigation.navigate(pushTo)}>
    ...
    <SafeAreaView style={globalStyle.mainContainer}>
        ...
        <Text style={{position: 'absolute', bottom: 0, color: "#eee", paddingLeft: 10, paddingRight: 10}}>all content is made abailable for user availability, I do not own any of these properties</Text>
        </View>
    </SafeAreaView>
    );
